...
const Home = () => {
  ...
  const SocialLinks = () => {
    return (
      <div className="md:flex md:flex-wrap gap-3 items-center hidden md:pt-[115%] ">
        <a
          href="https://www.facebook.com/Sanjeev073.sah/"
          target="_blank"
          rel="noopener noreferrer"
          className="p-3 border border-purple-600 rounded-full"
        >
          <FacebookIcon className="w-4 h-4 md:w-6 md:h-6 text-blue-500 hover:scale-[1.2] transition-transform duration-50" />
        </a>
        <a
          href="https://github.com/sanjeevshah1"
          target="_blank"
          rel="noopener noreferrer"
          className="p-3 border border-purple-600 rounded-full"
        >
        ...
        <a
          href="https://np.linkedin.com/in/sanjeev-sah-b354b9210"
          target="_blank"
          rel="noopener noreferrer"
          className="p-3 border border-purple-600 rounded-full"
        >
        ...
        <a
          href="https://www.instagram.com/sanjeev_shah__/"
          target="_blank"
          rel="noopener noreferrer"
          className="p-3 border border-purple-600 rounded-full"
        >
        ...
        <button
          ...
          className="ml-0 px-0 p-2 md:px-4 md:py-3 flex items-center border md:relative md:-right-6 text-sm md:text-base text-white/80 hover:text-white/90 border-purple-600 bg-purple-600/80 rounded-full"
        >
          Download Resume
        </button>
      </div>
  ...
  return (
    <>
      <main
        id="main"
        className="container  min-height-screen mx-auto px-4 pb-0 pt-4 sm:px-6 md:px-8 md:py-0 md:h-[calc(100vh-6rem)] mt-12 md:mt-6 lg:mt-6"
      >
        <Vortex
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-6 items-center max-w-5xl mx-auto">
            ...
            <div className="md:col-start-1 md:row-start-1 mt-1 flex flex-col justify-center md:justify-start  lg:mt-0">
              ...
              <button
                onClick={handleDownload}
                className="md:hidden mt-0 px-4 p-2 text-sm text-white/80 hover:text-white/90 border border-purple-600 bg-purple-600/80 rounded-full mb-8 max-w-fit mx-auto"
              >
                Download Resume
              </button>
